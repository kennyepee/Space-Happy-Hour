...
export function Hero() {
  return (
    <section id="home" className="vh-compact-hero relative w-full bg-[#121212]">
      {/* Capitol + headline overlaid; logos follow below */}
      <div className="vh-compact-hero-media relative min-h-[min(68vh,560px)] w-full overflow-hidden">
        <Image
        ...
        <div
          ...
          aria-hidden
        />
        <div className="vh-compact-hero-overlay absolute inset-0 flex flex-col items-center justify-center px-5 py-24 text-center sm:px-8">
          <h1 className="vh-compact-hero-title font-display flex max-w-4xl flex-col items-center gap-1 text-balance text-xl font-bold leading-tight tracking-[0.06em] text-white sm:gap-1.5 sm:text-3xl md:text-4xl">
      ...
      <div className="vh-compact-hero-logos mx-auto w-full max-w-4xl px-5 pb-2 pt-10 text-center sm:px-8 sm:pt-12 sm:pb-4">
      ...
      <div className="vh-compact-hero-copy mx-auto w-full max-w-3xl px-6 py-10 text-center md:px-10 md:py-14">
        ...
        <div className="vh-compact-hero-cta mt-10 flex justify-center">
          <Button
            asChild
            size="lg"
